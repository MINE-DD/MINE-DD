...
git branch -M main
git remote add origin git@github.com:MINE-DD/mine-dd
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/MINE-DD/repositories/new](https://github.com/organizations/MINE-DD/repositories/new)
and create a new repository named `mine-dd` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/MINE-DD/mine-dd/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
